...
# if (defined __STDC_VERSION__ && 201112L <= __STDC_VERSION__) \
     || (!defined __STRICT_ANSI__ \
         && ((defined __GNUC__ && 4 < __GNUC__ + (6 <= __GNUC_MINOR__)) \
...
#  define _GL_HAVE__STATIC_ASSERT 1
# endif
# if defined __clang_major__ && 4 <= __clang_major__ && 201411 <= __cpp_static_assert
#  define _GL_HAVE__STATIC_ASSERT1 1
# endif
# if (defined __cplusplus && 201703L <= __cplusplus) \
     || (defined __GNUC__ && 9 <= __GNUC__) \
     || (defined __clang_major__ && 4 <= __clang_major__ && 201411 <= __cpp_static_assert)
